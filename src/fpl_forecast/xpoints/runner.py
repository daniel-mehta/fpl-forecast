...
def _manifest(
    *,
    ...
    return {
        ...
        "simulation_architecture": config.architecture_type,
        "model_contract_version": config.model_contract_version,
        "draw_count": config.draw_count,
        "random_seed": config.random_seed,
        "seed_derivation_policy": config.seed_derivation_policy,
        "convergence_tolerances": {
            "mean_median_abs": config.mean_median_abs_tolerance,
            "mean_p95_abs": config.mean_p95_abs_tolerance,
            "probability_p95_abs": config.probability_p95_abs_tolerance,
            "component_reconciliation": config.component_reconciliation_tolerance,
        },
